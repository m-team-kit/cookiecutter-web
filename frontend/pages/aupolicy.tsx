...
const AUPolicy: NextPage = () => (
    <Layout>
        ...
        <p>
            ...
            defines the rules and conditions that govern your access to and use (including
            transmission, processing, and storage of data) of the resources and services
            (&quot;Services&quot;) as granted by the department{' '}
        ...
        <p>
            The KIT-SCC Impressum is found here:{' '}
            <a href="https://www.scc.kit.edu/en/legals.php">Legals</a>
        </p>
        <hr />
        <p id="footnote-aup-ref">
            <small>
                [1] This Acceptable Use Policy and Conditions of Use is based on{' '}
                <a href="https://wise-community.org/wise-baseline-aup/">WISE Baseline AUP</a>.{' '}
                <a href="#footnote-1" title="back">
                    &#8617;
                </a>
            </small>
        </p>
